...
%Мы хотим построить нормально распределённые обучающие выборки TS1 и TS2
%(TS - training set - обучающая выборка)
%Для этого нам нужно знать их параметры - МО и матрицы ковариаций
% Размерность задачи p = 3
% Пусть вектора мат ожиданий:
%  mu1 = [0, 0, 0]
%  mu2 = [0.3, 0.8, 1]
% Пусть матрица ковариаций Sigma - единичная матрица
%                                  
% 
